 ...
 * @param {Array.<string>=} combinedModuleIds 被合并的模块 id
 */
function Module(moduleId, ctx, bundleConfig, combinedModuleIds) {
    ...
    this.prepare();
    this.combinedModuleIds = combinedModuleIds;
}
 ...
 * @return {Array<string>}
 */
Module.prototype.getCombineModuleIds = function () {
    return this.combinedModuleIds;
};
...
Module.prototype._bundleSingleModule = function (def) {
    ...
    deps.forEach(function (depId) {
        ...
        var module = new Module(depId, this.compilerContext, this.bundleConfig, this.combinedModuleIds);
        this.combinedModuleIds && this.combinedModuleIds.push(depId);
