...
exports.replaceRequireResource = function (code, pluginId, resourceReplacer, moduleId) {
    return replaceRequireResource(code, pluginId, resourceReplacer, moduleId);
};
...
exports.processCSS = function (postcss, code, processOptions) {
    var deferred = Q.defer();
