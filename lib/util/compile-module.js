...
function initializeExcludeMap( moduleInfo, moduleSet ) {
    ...
    var dependencies = moduleInfo.actualDependencies;
    dependencies.push.apply( dependencies, Object.keys( explicitIncludeModules ) );

    var len = dependencies.length;
    while( len -- ) {
        var depId = dependencies[ len ];
        if ( explicitExcludeModules[ depId ] ) {
            dependencies.splice( len, 1 );
        }
    }
