...
describe('babel-processor', function () {
    ...
    it('default', function (done) {
        ...
        base.launchProcessors([p0, p1], processContext, function () {
            ...
            expect(fi.data).to.eql('define(["exports","babel-runtime/helpers/inherits","babel-runtime/helpers/class-call-check"],function(exports,e,t){(function(l){function n(){t.default(this,n),l.apply(this,arguments)}return e.default(n,l),n.prototype.toString=function(){console.log("HelloWorld")},n})(Array)});');
            done();
        });
    });
});
